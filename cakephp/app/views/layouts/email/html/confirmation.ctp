...
<tr>
    <td align="center" valign="top">
        ...
        <table cellspacing="0" cellpadding="0" border="0" width="650">
            <tr>
                <td valign="top"><a href="<?= $data['url']?>"><img src="<?= $data['logo']?>" alt="<?= $data['alt-text']?>"  style="margin-bottom:10px;" border="0"/></a></td>
            </tr>
        </table>
        <!-- [ middle starts here] -->
        <table cellspacing="0" cellpadding="0" border="0" width="650">
                ...
                <td valign="top">
                 ...
                 <?= $data['thankyou_text']?></p>
                  <p>Bevestiging</p>
                    ...
                    <h3 style="border-bottom:2px solid #eee; font-size:1.05em; padding-bottom:1px; ">Bestelling nr: <?= $data['order_number']?> geplaatst op <?= $data['order_date']?></h3>
